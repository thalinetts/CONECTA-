...
## 🎯Objetivos Principais
 ...
 - **Engajamento:** Incentivar o voluntariado universitário através da emissão de certificados de horas complementares.
 - **Impacto Social:** Alinhamento direto com as ODS 1, 10, 11 e 17 da ONU.

## ✨Funcionalidades
**Para Voluntários e Doadores:**
  - Cadastro Seguro: Login com verificação de CPF.
  - Busca Inteligente: Filtros por nicho (Causa Animal, Educação, Fome, etc.) e por proximidade (Geolocalização).
  - Gamificação: Sistema de conquistas e medalhas por metas alcançadas.
  - Certificação: Emissão automática de certificados de horas para fins académicos.
  - Histórico: Tabela detalhada de todas as ONGs e causas já apoiadas.

**Para ONGs:**
  - Gestão de Demandas: Publicação de vagas para voluntários e listas de itens necessários.
  - Comunicação Direta: Chat integrado para alinhamento com interessados.
  - Segurança: Perfil verificado para aumentar a credibilidade junto aos doadores.
  - Sistema de Avaliação: Receber e dar feedbacks, construindo uma reputação na rede.
