...
// Centralizando todos os imports de imagem no topo para evitar erros de build
...
const Homepage = () => {
  return (
    <div className="hp-main-wrapper">
      ...
      {/* Seção de Compromissos (Cards 1 a 4) */}
        ...
        <div className="hp-commitments-grid">
          ...
          <div className="hp-commitment-card">
            ...
            <div className="hp-card-content">
              ...
              <img src={img1} alt="Transformação Digital" />
            </div>
          </div>
          ...
          <div className="hp-commitment-card">
            ...
            <div className="hp-card-content">
              ...
              <img src={img2} alt="Conexão Segura" />
            </div>
          </div>
          ...
          <div className="hp-commitment-card">
            ...
            <div className="hp-card-content">
              ...
              <img src={img4} alt="Metas Globais" />
            </div>
          </div>
          ...
          {[1, 2, 3].map((item) => (
            <div key={item} className="hp-ong-card">
              <div className="hp-ong-image-container">
                {/* Usando a heroImg como placeholder para as ONGs */}
                <img src={heroImg} alt="ONG em destaque" />
              </div>
      ...
      <section className="hp-rewards-section">
        <div className="hp-rewards-container">
          ...
          <div className="hp-rewards-image">
            <img src={img5} alt="Troféu de Conquistas" />
          </div>
        </div>
      </section>
